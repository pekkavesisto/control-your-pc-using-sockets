...
The client will only connect to the server if the server is running on the same computer, BUT there is a way how you can control your computer from almost any device. [Here](https://github.com/pekkavesisto/control-your-pc-using-sockets/blob/main/README.md#control-your-computerlaptop-from-another-computerlaptop)
